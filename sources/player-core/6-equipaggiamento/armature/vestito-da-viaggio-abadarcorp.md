---
traits: [esposto, tecnologico]
source: Player Core (Eng), pag. 248
original-name: Abadarcorp Travel Suit
original-srd: https://2e.aonsrd.com/equipment/armor/3-abadarcorp-travel-suit
itemCategories: [base-armor]
---

# Vestito Da Viaggio Abadarcorp - Oggetto 0

**Categoria** Leggera; **Prezzo** 10 crediti

**Bonus CA** +1; **Des Massimo** +3; **Pen. Prove** —; **Pen. Velocità** —

**Forza** +0; **Volume** L; **Migliorie** 2
