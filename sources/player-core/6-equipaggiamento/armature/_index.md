---
source: Player Core (Eng), pag. 244
original-name: Armor
...
L’armatura aumenta le difese del tuo personaggio, anche se alcune armature medie
o pesanti possono ostacolarne i movimenti. Se vuoi aumentare la difesa del tuo
personaggio, oltre a quella fornita dalla tua armatura, puoi usare uno scudo.
L’armatura protegge il tuo personaggio solo mentre la sta indossando.

---

## Classe Armatura

La tua **Classe Armatura (CA)** misura quanto bene puoi difenderti contro gli
attacchi. Quando una creatura ti attacca, la tua Classe Armatura è la CD per
quel tiro per colpire.

Usa il tuo bonus di competenza relativo alla categoria (leggera, media o
pesante) o al tipo specifico di armatura che stai indossando. Se non stai
indossando un’armatura, usa la tua competenza nella difesa senz’armatura.

## Indossare e Togliersi l’Armatura

Vestirsi e spogliarsi di un’armatura richiede tempo, quindi assicurati di averla
indosso quando ne hai bisogno! Indossare e togliersi un’armatura sono entrambe
attività che comportano molte azioni Interagire. Indossare un’armatura leggera
richiede 1 minuto, un’armatura media o pesante 5 minuti e togliersi qualsiasi
armatura richiede 1 minuto.

## Protezione Ambientale

La galassia è un luogo vasto e meraviglioso, pieno di innumerevoli pericoli e
mondi, ma lo spazio è inospitale e incredibilmente letale. Ogni tipo di armatura
moderna possiede protezioni ambientali integrate che, quando attivate, ti
proteggono dal vuoto dello spazio. Queste protezioni ti permettono di
sopravvivere per alcuni giorni se devi effettuare riparazioni allo scafo di
un'astronave, esplorare un mondo alieno privo di aria o resistere
all’esposizione dovuta a una breccia ambientale mentre sei intrappolato in una
stazione spaziale. Alcune armature ottengono questo tramite un campo ambientale
(un piccolo campo di forza regolato appositamente per proteggere dal vuoto e che
non riduce i danni degli attacchi), mentre altre possono essere chiuse con
caschi e sigilli ermetici. Mentre utilizzi le protezioni ambientali della tua
armatura, questa può proteggerti dagli effetti ambientali pericolosi del vuoto e
facilitare una respirazione autosufficiente. Questo ti permette di sopravvivere
e respirare in un’atmosfera densa o rarefatta, in un vuoto o mentre sei immerso
in un liquido (le guarnizioni di sicurezza e il respiratore non offrono alcuna
protezione dagli effetti di liquidi dannosi, come acido o lava). La protezione
dell’armatura non ti protegge dall’inalazione di fumo, veleni inalati, atmosfere
tossiche o corrosive.

Le protezioni ambientali dell’armatura funzionano solo in un’atmosfera densa o
rarefatta, in un vuoto o in un liquido non pericoloso. In tutti gli altri
ambienti, l’armatura è progettata per ridurre l'attività, ricaricare la sua
riserva d’aria e filtrare l’ambiente circostante entrando in modalità a bassa
...
[esposto](/tratti/esposto), ti permettono di respirare e sopravvivere in
un’atmosfera densa o rarefatta, in un vuoto o in ambienti subacquei non
pericolosi. Questo non impedisce a tossine inalate o effetti simili di penetrare
nei sistemi della tua armatura. Le stirpi come i kalo, che richiedono condizioni
ambientali specifiche per sopravvivere, possono facilmente ottenere o modificare
un’armatura per soddisfare queste necessità. Chi la indossa può attivare o
disattivare le protezioni dell’armatura con un’azione
[Interagire](/azioni/interagire). Le protezioni ambientali di una corazza durano
per un numero di giorni pari al suo livello oggetto (minimo 1 giorno).

### Attivazione e Durata

Le protezioni ambientali di una corazza durano per un numero di giorni pari al
suo livello oggetto. Attivare o disattivare queste protezioni ambientali
richiede una singola azione [Interagire](/azioni/interagire) se stai indossando
l’armatura. Attivare le protezioni ambientali su un’armatura indossata da una
creatura consenziente richiede 2 azioni e possiede il tratto
[maneggiare](/tratti/maneggiare). Grazie ai sistemi di sicurezza integrati, non
puoi disattivare le protezioni ambientali di un’armatura indossata da una
creatura non consenziente.

La durata delle protezioni ambientali dell’armatura è consumata in incrementi di
1 giorno. Ricaricare questa durata richiede accesso a un’astronave funzionante o
a una stazione di ricarica ambientale (di solito disponibile nella maggior parte
degli insediamenti tecnologicamente avanzati o mediamente avanzati) e richiede
10 minuti. La maggior parte delle stazioni che ricaricano dispositivi, come le
batterie, ricaricano anche le protezioni ambientali delle armature, e il loro
utilizzo è tipicamente gratuito. Le altre funzioni dell’armatura che non
possiedono una durata continuano a funzionare normalmente.

## Statistiche delle Armature

La tabella Armature presenta le statistiche per le armature che possono essere
acquistate e indossate, organizzate per categoria. Le colonne in entrambe le
tabelle forniscono le seguenti statistiche.

### Categoria

La categoria dell’armatura (senz’armatura, armatura leggera, armatura media o
armatura pesante) indica quale bonus di competenza usi mentre stai indossando
l’armatura.

### Bonus alla CA

Questo numero è il bonus di oggetto che sommi all’armatura quando determini la
Classe Armatura.
...
Mentre indossi la tua armatura, subisci questa penalità alle prove di abilità
basate su Forza e Destrezza, tranne per quelle che possiedono il tratto attacco.
Se soddisfi la soglia di Forza dell’armatura (vedi [Forza](#forza) di seguito)
non subisci questa penalità.

### Penalità alla Velocità

Mentre indossi un’armatura subisci penalità alla tua Velocità, indicata a questa
voce, così come a qualsiasi altro tipo di movimento che possiedi, come Velocità
di scalare o Velocità di nuotare, fino a una Velocità minima di 1,5 metri. Se
soddisfi la soglia di Forza dell’armatura (vedi [Forza](#forza) di seguito),
riduci la penalità di 1,5 metri.

### Forza

Questa voce indica il punteggio di Forza minimo necessario per ridurre o
annullare alcune penalità imposte dall’armatura. Se la tua Forza è pari o
superiore a questo valore, non subisci più penalità di armatura alle prove e
riduci di 1,5 metri la penalità alla Velocità (fino a nessuna penalità se questa
era di -1,5 metri, oppure fino a una penalità di -1,5 metri se la penalità era
di -3 metri).

### Volume

Questa voce indica il Volume dell’armatura, presupponendo che tu stia indossando
l’armatura e che il suo peso sia distribuito sul tuo corpo. Un’armatura che
viene trasportata di solito ha 1 Volume in più rispetto a quello elencato (o ha
...
Ogni tipo di armatura media o pesante appartiene a un gruppo di armature che le
classifica insieme a tipi analoghi di armatura. Alcune capacità fanno
riferimento ai gruppi di armature, generalmente per concedere effetti di
[specializzazione dell’armatura](#effetti-di-specializzazione-dellarmatura).
...
tecnologia. Le rune dell’armatura (_Pathfinder GM Core_ 226) non funzionano su
questa armatura a meno che essa non abbia anche il tratto
[arcaico](/tratti/arcaico). Le armature analogiche hanno solitamente il tratto
[esposto](/tratti/esposto).

[**Arcaica**](/tratti/arcaico)**:** Questa armatura è realizzata utilizzando
metodi e materiali tradizionali. Tutte le armature di Pathfinder hanno il tratto
arcaico. Le rune dell’armatura (_Pathfinder GM Core_ 226) funzionano normalmente
con un’armatura arcaica.

[**Baluardo**](/tratti/baluardo)**:** L’armatura ti copre in modo così completo
da fornirti dei benefici contro alcuni effetti che infliggono danni. Ai TS su
Riflessi per evitare un effetto che infligge danni, come ad esempio una palla di
fuoco, aggiungi un modificatore di +3 invece del tuo modificatore di Destrezza.

[**Confortevole**](/tratti/confortevole)**:** L’armatura è talmente comoda che
puoi riposare normalmente mentre la stai indossando.

[**Esposta**](/tratti/esposto)**:** Questa armatura non è dotata di protezioni
ambientali. Tutte le armature [arcaiche](/tratti/arcaico) hanno il tratto
esposto.

[**Flessibile**](/tratti/flessibile): L’armatura è abbastanza flessibile da non
ostacolare la maggior parte delle azioni. Non applichi la sua penalità alle
prove per le prove di Acrobazia o Atletica.

[**Ponderosa**](/tratti/ponderoso)**:** L’armatura ha parti mobili o altri
elementi completi che rallentano il tempo di reazione di chi la indossa. Mentre
indossi l’armatura subisci penalità -1 alle prove di iniziativa. Se non soddisfi
il requisito del punteggio di Forza dell’armatura, questa penalità incrementa
fino alla penalità alle prove dell’armatura, se è peggiore.

[**Resiliente**](/tratti/resiliente)**:** Questa armatura è stata sviluppata con
diversi sistemi integrati di ricalibrazione e difesa. Mentre indossi
quest’armatura, ottieni un bonus oggetto ai tiri salvezza pari al valore
indicato.

[**Rumorosa**](/tratti/rumoroso): Quest’armatura è rumorosa ed è probabile che
allerti gli altri della tua presenza. La penalità alle prove dell’armatura si
applica alle prove di Furtività anche se soddisfi il punteggio di Forza
richiesto.

[**Tecnologica**](/tratti/tecnologico)**:** Questa armatura incorpora
elettronica, sistemi informatici, fonti di energia integrate e un’unità di
comunicazione.

## Effetti di Specializzazione dell’Armatura

Certi privilegi di classe possono concederti benefici aggiuntivi con alcune
armature, e questo è detto effetto di specializzazione dell’armatura. L’effetto
esatto dipende dal gruppo di armature al quale appartiene la tua armatura, come
elencato di seguito.

**Ceramica:** Delicate ma robuste, le piastre in ceramica trattata sono comuni
nelle tute spaziali. Resistono al calore e ad altri pericoli ambientali e sono
abbastanza leggere da essere indossate agevolmente. Ottieni resistenza ai danni
da acido, freddo, fuoco ed elettricità pari a 1 + il valore di resiliente
dell’armatura per un’armatura media, oppure 2 + il valore di resiliente
dell’armatura per un’armatura pesante.

**Composita:** Le numerose parti sovrapposte di quest’armatura ti proteggono
dagli attacchi perforanti. Ottieni resistenza ai danni perforanti pari a 1 + il
valore di resiliente dell'armatura per le armature medie, oppure 2 + il valore
di resiliente dell’armatura per quelle pesanti.

**Cuoio:** Lo spesso secondo strato dell’armatura disperde la forza dell’impatto
per ridurre il danno contundente. Ottieni resistenza ai danni contundenti pari a
1 + il valore di resiliente dell'armatura per le armature medie, oppure 2 + il
valore di resiliente dell’armatura per quelle pesanti.

**Maglia:** L’armatura è così flessibile che può piegarsi subendo un colpo
critico e assorbirne parte dell’impatto. Riduci il danno da colpi critici di 4 +
il valore di resiliente dell’armatura per le armature medie, oppure di 6 + il
valore di resiliente dell’armatura per quelle pesanti. Questo non può ridurre il
danno a un valore inferiore al danno tirato per il colpo prima di raddoppiare
per un colpo critico.

**Piastre:** Le robuste piastre deflettono le lame taglienti. Ottieni resistenza
ai danni taglienti pari a 1 + il valore di resiliente dell'armatura per le
armature medie, oppure 2 + il valore di resiliente dell’armatura per quelle
pesanti.

**Polimeri:** Questa armatura flessibile ti protegge dal calore e dalla forza
