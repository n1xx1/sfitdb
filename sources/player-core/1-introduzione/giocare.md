---
source: Player Core (Eng), pag. 8
original-name: Playing the Game
original-srd: https://2e.aonsrd.com/rules/11-playing-the-game
...
> ## Parole Chiave
>
> Durante la creazione del tuo primo personaggio (o avventura) avrai bisogno di
> conoscere alcuni termini importanti. Alcuni dei termini più importanti
> menzionati nelle pagine precedenti vengono inclusi anche qui come riferimento.
>
> ### Abilità
>
> Un’abilità rappresenta la capacità di una creatura di eseguire determinati
> compiti che richiedono istruzione o pratica. Tutti i personaggi sono
> addestrati in alcune abilità per via del loro background e della loro classe.
> Le abilità sono descritte nel Capitolo 4. Ogni abilità riporta dei modi in cui
> chiunque può usarla, anche se privo di addestramento, così come usi che
> richiedono che un personaggio sia addestrato in quell’abilità.
>
> ### Attacco
>
> Quando una creatura tenta di arrecare danno a un’altra creatura, sferra un
> Colpo o utilizza un’altra azione di attacco. La maggior parte degli attacchi
> sono Colpi sferrati con un’arma, ma un personaggio potrebbe Colpire con un
> pugno, lottare e spingere usando le mani, o attaccare con un incantesimo.
>
> ### Background
>
> Il background rappresenta le esperienze vissute dal personaggio prima di
> intraprendere la carriera da avventuriero. Ogni background concede un talento
> e addestramento in una o più abilità. Puoi scoprire di più sui background nel
> Capitolo 2.
>
> ### Bonus e Penalità
>
> I bonus e le penalità si applicano alle prove e ad alcune statistiche. Ne
> esistono vari tipi. Se hai più di un bonus dello stesso tipo, usi solo quello
> più alto; allo stesso modo, usi solo la penalità peggiore di ciascun tipo.
>
> ### Classe
>
> La classe rappresenta la professione da avventuriero scelta da un personaggio.
> La classe di un PG determina la maggior parte delle sue competenze, fornisce
> al personaggio un certo numero di Punti Ferita quando ottiene un nuovo livello
> e dà accesso a una serie di talenti di classe. Le classi appaiono nel
> Capitolo 3.
>
> ### Classe Armatura (CA)
>
> Tutte le creature nel gioco hanno una Classe Armatura. Questo punteggio
> rappresenta quanto è difficile colpire e danneggiare una creatura. In genere
> serve come Classe Difficoltà per colpire una creatura con un attacco.
>
> ### Competenza
>
> La competenza misura l’attitudine di un personaggio in un certo compito o
> qualità e ha cinque gradi: senza addestramento, addestrato, esperto, maestro e
> leggendario. La competenza conferisce un bonus da aggiungere nel momento in
> cui determini le seguenti statistiche e modificatori: CA, tiri per colpire,
> Percezione, tiri salvezza, abilità ed efficacia degli incantesimi. Se sei
> senza addestramento, il tuo bonus di competenza è +0. Se sei addestrato,
> esperto, maestro o leggendario, Il tuo bonus di competenza è pari al tuo
> livello più, rispettivamente, 2, 4, 6 o 8.
>
> ### Condizione
>
...
> ### Game Master (GM)
>
> Il Game Master è il giocatore che decide sulle regole e narra i vari elementi
> della storia di Pathfinder e del mondo che gli altri giocatori esplorano. Il
> GM usa le regole trovate in Pathfinder Manuale del GM.
>
> ### Interpretare
>
> Descrivere le azioni di un personaggio, spesso mentre si agisce dal punto di
> vista del personaggio stesso, è chiamato interpretare. Quando un giocatore
> parla o descrive l’azione dalla prospettiva di un personaggio, è entrato “nel
> ruolo”.
>
> ### La Galassia
>
> Starfinder è ambientato nei Mondi del Patto, un sistema di pianeti alleati che
> un tempo ospitava il mondo perduto di Golarion, anche se molte avventure
> esplorano la galassia più ampia. Ulteriori informazioni sulla galassia si
> trovano a pagina 30 e nei manuali _Starfinder Galaxy Guide_ e _Starfinder GM
> Core_.
>
> ### Incantesimo
>
> Gli incantesimi sono effetti magici generati dall’uso della magia, tramite
> incantamenti e gesti mistici noti solo a chi possiede uno speciale
> addestramento o delle capacità innate. Lanciare incantesimi è un’attività che
> in genere richiede due azioni. Gli incantesimi specificano il loro bersaglio,
> gli effetti, le azioni necessarie per lanciarli e come si può resistere ad
> essi. Se una classe conferisce incantesimi, il funzionamento basilare di
> questa capacità compare nella descrizione della classe, nel Capitolo 3, mentre
> gli incantesimi in quanto tali vengono descritti nel Capitolo 7.
>
> Gli incantesimi hanno dei gradi che vanno dal 1° al 10° e ne misurano il
> potere; personaggi e mostri di solito possono lanciare solo un certo numero di
> incantesimi di un dato grado.
>
> ### Iniziativa
>
> All’inizio di un incontro, tutte le creature coinvolte tirano l’iniziativa per
> determinare l’ordine in cui agiscono. Più alto è il risultato del suo tiro,
> prima una creatura agisce. Iniziativa e combattimento sono descritti nel
> Capitolo 8.
>
> ### Livello
>
> Un livello è un numero che misura la potenza complessiva di qualcosa. Un
> personaggio ha un livello che va dal 1° al 20° e rappresenta il suo livello di
> esperienza. Mostri, PNG, pericoli, malattie e veleni hanno un livello da -1 a
> 30 che misura il rischio che rappresentano. Il livello di un oggetto indica il
> suo potere e la sua appropriatezza come tesoro e in genere va da 0 a 20, ma
> talvolta anche oltre.
>
> ### Modificatore di Attributo
>
> Ogni creatura ha sei modificatori di attributo: Forza, Destrezza,
> Costituzione, Intelligenza, Saggezza e Carisma. Ognuno rappresenta il
> potenziale grezzo di un personaggio e il suo addestramento generale. Gli
> attributi sono descritti in dettaglio più avanti in questo capitolo.
>
> ### Percezione
>
> La Percezione misura la capacità del tuo personaggio di notare oggetti
> nascosti o situazioni insolite, e di solito determina quanto velocemente
> agisca in combattimento. Per saperne di più, consulta il Capitolo 9.
>
...
>
> Un personaggio non giocante, controllato dal GM, interagisce con i giocatori e
> aiuta lo sviluppo della storia.
>
> ### Punti Ferita (PF)
>
> I Punti Ferita rappresentano la quantità di danni che una creatura può
> sopportare prima di cadere priva di sensi e iniziare a morire. I danni
> riducono i Punti Ferita secondo un rapporto 1 a 1, e la guarigione ripristina
> i Punti Ferita nella stessa proporzione.
>
> ### Rarità
>
> Alcuni elementi del gioco hanno una loro rarità che descrive quanto spesso si
> incontrano nel mondo del gioco. La rarità si applica principalmente
> all’equipaggiamento e agli oggetti magici, ma anche incantesimi, talenti e
> altri elementi regolistici hanno una rarità. Se la rarità non compare tra i
> tratti di un oggetto, di un incantesimo o di qualche altro elemento del gioco,
> significa che ha rarità comune. Le opzioni non comuni sono accessibili solo a
> coloro che hanno un tipo speciale di addestramento, che sono cresciuti in una
> certa cultura o che provengono da un luogo particolare. Questo può essere
> spiegato in una voce "Accesso", dove vengono indicati i criteri in base ai
> quali i personaggi possono considerare l'opzione come fosse comune. Le opzioni
> rare sono praticamente impossibili da trovare e di solito vengono assegnate
> dal GM, mentre delle opzioni uniche esiste letteralmente un solo esemplare nel
> mondo di gioco. Il GM può modificare il funzionamento della rarità o la rarità
> di un singolo oggetto ai fini della storia che intende raccontare.
>
> ### Round
>
> Il round è una frazione di tempo nella quale tutti i partecipanti a un
> incontro hanno la possibilità di agire. Esso corrisponde a circa 6 secondi nel
> mondo di gioco.
>
> ### Stirpe
>
> La stirpe è l’ampia famiglia di persone a cui appartiene un personaggio. La
> stirpe determina i Punti Ferita iniziali, le lingue, la Velocità e i sensi di
> un personaggio e fornisce l’accesso ai talenti di stirpe. Le stirpi sono
> descritte nel Capitolo 2.
>
> ### Talenti
>
> Un talento è una capacità che un personaggio riceve dalla propria stirpe, dal
> suo background, dalla sua classe, dall’addestramento generico che ha ricevuto
> o dal suo addestramento nelle abilità. Alcuni talenti permettono di utilizzare
> delle azioni speciali, mentre altri rendono più efficaci le azioni già a
> disposizione.
>
> ### Tiro Salvezza (TS)
>
> Quando una creatura è soggetta a effetti pericolosi che deve cercare di
> evitare, effettua un tiro salvezza per mitigarne gli effetti. Un tiro salvezza
> è automatico: non devi spendere un’azione o una reazione per effettuarlo. A
> differenza della maggior parte delle prove, è il personaggio che non sta
> agendo a tirare il d20 per un tiro salvezza, mentre la creatura che sta agendo
> fornisce la CD.
>
> Esistono tre tipi di tiri salvezza: Tempra (per resistere a veleni, malattie
> ed effetti fisici), Riflessi (per mitigare gli effetti di ciò che il PG può
> schivare con rapidità) e Volontà (per resistere agli effetti che influenzano
> la mente e la personalità).
>
> ### Tratto
>
> Un tratto è una parola chiave che serve a impartire informazioni aggiuntive su
> un determinato elemento di regole, ad esempio a quale stirpe appartenga un
> talento o la rarità di un oggetto. Spesso, i tratti servono a indicare come
> altre regole interagiscono con capacità, creature, oggetti, o altri elementi
> di regole che hanno quel tratto. I tratti utilizzati in questo libro appaiono
> nel Glossario e Indice, a partire da pag. 442.
>
> ### Turno
>
> Durante il corso di un round, ogni creatura ha un singolo turno che dipende
> dal suo ordine di iniziativa. Una creatura di solito può usare fino a 3 azioni
> durante il suo turno.
>
> ### Valuta
>
> La valuta più comune nel gioco è costituita dai crediti. I personaggi iniziano
> il gioco con 150 crediti da spendere in equipaggiamento.
>
> ### Velocità
>
> La velocità rappresenta la distanza che un personaggio può percorrere
> utilizzando un’azione singola, misurata in metri.
