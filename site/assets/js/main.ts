document.addEventListener("DOMContentLoaded", function () {
  ...
  const overlayClasses = ["fixed", "inset-0", "z-10", "bg-black/80"];
  ...
  function toggleMenu() {
    ...
    const scollbar = Math.max(0, document.documentElement.clientWidth - width);
    document.body.style.paddingRight = `${scollbar}px`;
  }
